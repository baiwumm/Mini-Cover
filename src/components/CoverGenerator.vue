<template>
  <main
    class="container mx-auto max-w-[1600px] p-4 flex flex-col lg:flex-row lg:flex-wrap justify-center items-center gap-5"
  >
    <!-- 控制面板 -->
    <div class="w-full lg:flex-1 flex flex-col p-4 bg-white rounded-lg shadow-md">
      ...
      <div class="flex flex-col sm:flex-row mb-3">
        <div
          ...
          :class="
            state.hasMultipleLines ? ['opacity-100 mb-3 sm:mb-0 sm:mr-4', 'w-full sm:w-[300px]'] : 'h-0 opacity-0 w-0'
          "
        >
...
export default {
  ...
  data() {
    return {
      state,
      defaultConfig,
      iconName: "fluent-emoji-flat:four-leaf-clover",
      iconUrl: null,
      dragHighlight: null,
    };
  },
